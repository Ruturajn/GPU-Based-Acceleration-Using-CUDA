...
parent_node *create_node(def_point point_){
...
//     }
//     else
//         root_node = create_node(point_);

//     parent_node *curr_node = root_node;
...
//         if (axis == 0)
//         {
//             if (point_.x >= curr_node->node_me.x)
//                 curr_node = curr_node->node_right;
//             else
//                 curr_node = curr_node->node_left;
//         }
//         else
//         {
//             if (point_.y >= curr_node->node_me.y)
//                 curr_node = curr_node->node_right;
//             else
//                 curr_node = curr_node->node_left;
//         }
...
//     curr_node = create_node(point_);

//     return root_node;
// }

// Function to insert a new point in the kdtree
bool search_node(parent_node *root_node, def_point point_, int depth)
{
    if (root_node == NULL)
        return false;
    ...
    while (root_node != NULL)
    {
        ...
        {
            if (point_.x >= root_node->node_me.x)
                root_node = root_node->node_right;
            else
                root_node = root_node->node_left;
        }
        else
        {
            if (point_.y >= root_node->node_me.y)
...
int main()
{
    ...
    if (search_res == true)
        cout << "Found Point "
             << "(" << test_point.x << "," << test_point.y << ") : True" << endl;
    else
        cout << "Found Point "
             << "(" << test_point.x << "," << test_point.y << ") : False" << endl;
    return 0;
}